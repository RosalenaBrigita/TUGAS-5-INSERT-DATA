        ...
        <div class="container">
            ...
            <div class="nav">
                <ul>
                    ...
                    <li>
                        <a class="nav-link" href="<?php echo "prod.php"; ?>">Products</a>   
                    </li>           
                </ul>              
            </div>
            <div class="main">
            ...
            <section class="customers adjust" >
                ...
                <div class="title">
                    ...
                    <div class="search">
                        ...
                        <div class="input">
                            <form method="GET" action="cust.php" style="text-align: left">
                        ...
                        <a href="tambahDataCust.php" id="tombol">Insert New Data</a>
                    </div>
